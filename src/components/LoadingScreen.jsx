...
export function LoadingScreen() {
    ...
    // Pig Path Data (Reused for Outline and Mask)
                ...
                <div className="piggy-container">
                    ...
                    >
                        <defs>
                            ...
                            <mask id="pig-mask">
                                <path d={pigBodyPath} fill="white" />
                                <circle cx="25.38" cy="16.71" r="1.36" fill="black" /> {/* Eye Hole */}
                            </mask>
                        </defs>

                        {/* 1. Base Outline (Visible Container) */}
                        <path
                            d={pigBodyPath}
                            fill="none"
                            stroke="#334155"
                            strokeWidth="1.5"
                        />
                        <circle cx="25.38" cy="16.71" r="1.36" fill="#334155" />

                        {/* 2. Liquid Fill (Masked) */}
                        <g mask="url(#pig-mask)">
                            {/* Background of pig inside (optional, maybe light gray?) */}
                            <rect x="0" y="0" width="36" height="36" fill="#e2e8f0" opacity="0.3" />

                            {/* The Rising Gold Level */}
                            <rect
