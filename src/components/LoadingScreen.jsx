            ...
            <div className="piggy-wrapper">
                <div className="piggy-container">
                    ...
                    <svg
                        ...
                        fill="#94a3b8"
                    >
                        <path d="M19.72,10.47a11.65,11.65,0,0,0-6.31.52A.8.8,0,1,0,14,12.48,10.11,10.11,0,0,1,19.44,12a.8.8,0,1,0,.28-1.57Z"></path>
                        <circle cx="25.38" cy="16.71" r="1.36"></circle>
